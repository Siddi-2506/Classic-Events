...
<body>
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
        <table>
            ...
            <tr>
                <td>Time:</td>
                <td> <input type="text" name="website" value="<?php echo htmlspecialchars($website); ?>">
            ...
            <tr>
                <td>Classes:</td>
                <td> <textarea name="comment" rows="5" cols="40"><?php echo htmlspecialchars($comment); ?></textarea>
                </td>
            </tr>
