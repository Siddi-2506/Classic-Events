        ...
        <div class="gallery-grids-top">
            <div class="gallery-grids">
                ...
                <div class="col-md-3 gallery-grid">
                    <a class="example-image-link" href="images/<?php echo $row['img']; ?>" data-lightbox="example-set"
                        data-title=""><img class="example-image" src="images/<?php echo $row['img']; ?>" alt=""
                            height="200" /></a>
                    <a
                        href="book_birthd.php?id=<?php echo $row['id']; ?>"><?php echo "<input type='button' value='BOOK NOW' class='btn my'/>" ;?></a><br />
                </div>
                <?php } ?>
